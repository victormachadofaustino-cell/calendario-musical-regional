...
const Feedback = ({ mensagem, tipo = 'sucesso', aoFechar }) => {
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[3000] w-[90%] max-w-sm animate-in slide-in-from-top-4">
      <div className={`flex items-center gap-3 p-4 rounded-[1.5rem] shadow-2xl border ${
        ...
        <span className="flex-1 text-[11px] font-black uppercase tracking-tight leading-tight">
          {mensagem}
        </span>
